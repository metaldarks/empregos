					...
					if distance <= 1.2 and IsControlJustPressed(1,38) then
						-- if lastVehicle == configminer.lastveh and emp11.checkPlate(lastVehicle) and emp11.checkCrimeRecord() then
							if emp11.checkWeight() then
								...
								TriggerEvent("Notify","negado","<b>Ferramenta</b> ou <b>espaço na mochila</b> insuficientes.",3000)	
							end
						-- else
							-- TriggerEvent("Notify","negado","Você precisa do <b>veículo da mineradora</b> para fazer isso.",3000)
						-- end
					end
				end
			end
